...
contract MAJINBURN is Context, IERC20, Ownable {
    ...
    string private constant _name = "MAJIN BURN";
    string private constant _symbol = "MAJINB";
    ...
    constructor () {
        dev = payable(0x690974d63012154F6EaC427610c07db71C441955);
