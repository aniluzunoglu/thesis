...
/**
 ...
 You will experience the endless loop in here. 
 Will this ever end? Will this ever stop?

Website: https://www.omegatrium.com/

Twitter: https://twitter.com/omegatrium

Telegram: https://t.me/Omegatrium

 * 7/7 taxes
 * 3% wallet
 * 15% sell for the first 30 minutes
...
contract Omegatrium is Context, IERC20, Ownable {
    ...
    string private constant _name = "Omegatrium";
    string private constant _symbol = "OMEGATRIUM";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x534eF012d0D7E796468b4Bb1B78BC820deC30A96);
    ...
    function Omega() external onlyOwner() {
    ...
    function updateBuyFee(uint256 _fee) external onlyOwner {
        require(_fee <= 3, 'fee can not set more than 3%');
        _tokensBuyFee = _fee;
    }
