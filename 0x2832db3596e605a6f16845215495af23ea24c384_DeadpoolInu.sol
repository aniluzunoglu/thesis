...
contract DeadpoolInu is IERC20, Ownable
{
    ...
    string private constant _symbol = '$DPINU';
    ...
    //DevWallets
    address public Deadpool=payable(0x76808F99141129080f936F78fD527d2283Fd4Add);
    address public Marketing=payable(0x521c754B212eCb8Bb888b17ccCBa589CAD7A1265);
    //MainNet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Deadpool||addr==Marketing;
    }
    ...
    function CollectMarketingETH() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Deadpool).transfer((amount*25) / 100);
    ...
    function TeamChangeDeadpool(address newDeadpool) public onlyOwner{
      Deadpool=payable(newDeadpool);
    }
    ...
    function REL() public onlyOwner {
        ...
        liquidityToken.transfer(Deadpool, amount);
    ...
    function TeamCollectRemainingETH() public onlyOwner{
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
        (bool sent,) =Deadpool.call{value: (address(this).balance)}("");
        require(sent);
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    //external//////////////////////////////////////////////////////////////////////////////////////////////
