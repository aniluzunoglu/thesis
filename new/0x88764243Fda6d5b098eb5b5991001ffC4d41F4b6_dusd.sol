...
contract dusd is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 54805215042 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tReflectionFeeTotal;
    uint256 private _tBurnFeeTotal;

    string private _name = "Defi USD";
    string private _symbol = "DUSD";
    ...
    address public marketingTokenFeeWallet = 0x0000000000000000000000000000000000000000;
    address public marketingETHFeeWallet = 0x0000000000000000000000000000000000000000;
