...
contract BankOfTsuka is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bank of Tsuka";
    string private constant _symbol = "BOTSUKA";
