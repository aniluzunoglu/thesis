...
FUCK 401K, LETS RESTART FROM 201K
...
contract CLUB201K is Context, IERC20, Ownable {
    ...
    string public constant name =  "CLUB 201K";
    string public constant symbol =  "201K";
