...
contract PINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "PomPom Inu";
    ...
    address payable private _developmentAddress = payable(0x928b7d3E8A657D118e4cD0219fdeCF98B232BeD2); 
    address payable private _marketingAddress = payable(0x928b7d3E8A657D118e4cD0219fdeCF98B232BeD2);
