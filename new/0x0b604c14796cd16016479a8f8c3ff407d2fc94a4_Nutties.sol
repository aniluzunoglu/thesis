...
contract Nutties is ERC721A {
    ...
    function startTheShow(address[] calldata _addresses) external onlyOwner {
        // make sure the art is fully set before calling this!
        require(totalSupply() == 1, "The show is not ready to start");
