...
Hollows settle in Hueco Mundo, but can cross over to the Human World and Soul Society. 
...
contract HuecoMundo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hueco Mundo", "HOLLOW") {
