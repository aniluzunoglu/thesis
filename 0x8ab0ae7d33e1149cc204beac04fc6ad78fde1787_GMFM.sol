...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // uniswap router 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
...
contract GMFM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GM Future Millionaires", "GMFM") {
        ...
        treasuryBuyFee = 40;
        liquidityBuyFee = 20;
        totalBuyFees = rewardsBuyFee + treasuryBuyFee + liquidityBuyFee;
        
        rewardsSellFee = 40;
        treasurySellFee = 40;
        liquiditySellFee = 20;
        totalSellFees = rewardsSellFee + treasurySellFee + liquiditySellFee;

    	dividendTracker = new DividendTracker();
    	
    	treasuryWallet = address(0x91e10Ca1AEC8cbd40A5bF975d9a22f0b79B64cb3); // set as treasury wallet
    ...
    function updateBuyFees(uint256 _treasuryFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        treasuryBuyFee = _treasuryFee;
        rewardsBuyFee = _rewardsFee;
        liquidityBuyFee = _liquidityFee;
        totalBuyFees = treasuryBuyFee + rewardsBuyFee + liquidityBuyFee;
        require(totalBuyFees <= 250, "Must keep fees at 25% or less");
    }
    
    function updateSellFees(uint256 _treasuryFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        treasurySellFee = _treasuryFee;
        rewardsSellFee = _rewardsFee;
        liquiditySellFee = _liquidityFee;
        totalSellFees = treasurySellFee + rewardsSellFee + liquiditySellFee;
    ...
    function updatetreasuryWallet(address newtreasuryWallet) external onlyOwner {
        require(newtreasuryWallet != address(0), "may not set to 0 address");
    ...
    function swapBack() private {
        ...
        uint256 ethForLiquidity = ethBalance - ethForTreasury - ethForRewards;
