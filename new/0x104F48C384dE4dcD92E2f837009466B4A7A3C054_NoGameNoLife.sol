...
The quest is to complete the game. Our project will release our website with revolutionary puzzles and games at 30k market cap. 
Based dev and is well connected.  New players, join now and let's finish the quest together.

Telegram - http://t.me/NGNLERC
https://twitter.com/NGNLERC

Locked 1 day initially. Will extend at 15k market cap. 
At 30k market cap, release website and lock 1 month.
...
pragma solidity >=0.4.22 <0.9.0;
    ...
    contract NoGameNoLife is Context, IERC20, Ownable {
        ...
        string private _name = 'No Game No Life';
        string private _symbol = '$NGNL';
