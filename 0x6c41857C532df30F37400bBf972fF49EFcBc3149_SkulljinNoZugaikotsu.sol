...
/**
 ...
 $SKULLJIN - The God of Gems
 Max wallet - 1%
 0% buy / 12% sell 

https://t.me/SkulljinNoZugaikotsu
https://twitter.com/Skulljin_
...
contract SkulljinNoZugaikotsu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Skulljin No Zugaikotsu";
    string private constant _symbol = "SKULLJIN";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xD3de5979799Ecf41d4796B4bE0C5c16F190D4000);
    ...
    function Skulljin() external onlyOwner() {
