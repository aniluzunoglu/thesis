...
0% Tax "He approves our undertakings"

Telegram - https://t.me/AnnuitCoeptisERC
Twiiter - https://twitter.com/AnnuitCETH
Website - http://annuitcoeptiseth.com
...
pragma solidity >=0.4.22 <0.9.0;
    ...
    contract AnnuitCoeptis is Context, IERC20, Ownable {
        ...
        string private _name = 'Annuit Coeptis';
        string private _symbol = '👁⃤';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xbC4B71E3B01F31559B7cF245AE94Be0dc05E49a2, 'We can not exclude Uniswap router.');
