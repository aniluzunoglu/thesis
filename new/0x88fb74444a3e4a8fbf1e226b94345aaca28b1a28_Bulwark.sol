/*         
? ????? $???????
Generating value and providing a solution for the ERC community through dApps and utility projects. 
An introduction to Bulwark SaaS Tools, $BULWARK, and the Bulwark Ecosystem.

? ???? ?? $????????
A decentralized application platform based on the Ethereum blockchain, Bulwark provides decentralized 
applications based on the ERC-20 protocol. Tokens that offer valuable tools to the community are the 
most resilient during a market movement. The dApps and tools provided by Bulwark will be free of charge. 
Developing new dApps and improving existing ones will focus on all $BULWARK growth efforts. Additionally, 
marketing is about having applications used by a broad audience.

? ???? ?? ?????
Software as a service (or SaaS) is a way of delivering applications over the Internet—as a service. 
Instead of installing and maintaining software, you access it via the Internet, freeing yourself from
 complex software and hardware management.


    Telegram: https://t.me/bulwarkerc

    Website : http://bulwarktoken.com/

    Twitter: https://twitter.com/bulwarkerc
...
pragma solidity >=0.4.22 <0.9.0;
    ...
    contract Bulwark is Context, IERC20, Ownable {
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x976EC15f3678735a83dC3FB1fFC11E7e6e6Aa0dB, 'We can not exclude Uniswap router.');
