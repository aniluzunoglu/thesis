...
contract GUNDAMINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GUNDAMINU", "GUNDAM") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xA7359574406619e59455495d8f4fa89B28D89ed1); // marketing wallet
        devWallet = address(0xa640bcD304Fe7A7d0588CE61b1DA5408f82267Bd); // dev wallet
