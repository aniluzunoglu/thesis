...
contract ShibDiamond is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ShibDiamond";
    ...
    address payable private _developmentAddress = payable(0xb061Fc4A05D9d0a184eC302f175B9addBf2A2321); 
    address payable private _marketingAddress = payable(0xb061Fc4A05D9d0a184eC302f175B9addBf2A2321);
