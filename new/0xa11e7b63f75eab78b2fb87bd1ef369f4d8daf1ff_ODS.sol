...
contract ODS is ERC20, Ownable {
    ...
    string constant _name = "Odesius";
    string constant _symbol = "ODS";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100;  // 2% max tx
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100;  // 2% max wallet
    ...
    address private marketingFeeReceiver = 0xbfEa37f04cD76CA8B92eEBd5327AE7C8fCF5e9F8;
    address private devFeeReceiver = 0xbfEa37f04cD76CA8B92eEBd5327AE7C8fCF5e9F8;
    address private teamFeeReceiver = 0xbfEa37f04cD76CA8B92eEBd5327AE7C8fCF5e9F8;
