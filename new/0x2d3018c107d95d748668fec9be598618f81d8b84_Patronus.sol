...
A Stag Patronus who lived in the forbidden forest, is here to always protect you from the evil shadows on erc20 network . 
...
contract Patronus is Context, IERC20, Ownable {
    ...
    string private constant _name = "Stag Patronus";
    string private constant _symbol = "PATRONUS";
