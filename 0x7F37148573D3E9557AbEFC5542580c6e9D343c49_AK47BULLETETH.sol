/*
    🔫AK47 BULLET ETH🔫 | 100X |

    💲SLIPPAGE 3%
    💲Max buy 3%

    ✅TG: https://t.me/ak47bulleteth 
    ✅TW:https://twitter.com/ak47bulleteth
*/
...
contract AK47BULLETETH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 100 * 10**10 * 10**9; 
    uint256 public _maxbuy = 3 * 10**10 * 10**9; // maxtransaction 3% 
    uint256 public _maxwallet = 3 * 10**10 * 10**9; //maxwallet 3% 
    uint256 private minimumTokensBeforeSwap = 1000 * 10**9;   
    uint256 public _totaltax = 0;
    uint256 public _cooldown = 0;

    address payable public marketingWallet = payable(0xDFA9A2D68D9fE949a74b1Bd76a2A7E2699a82814); 
    address payable public rewardsWallet = payable(0xDFA9A2D68D9fE949a74b1Bd76a2A7E2699a82814); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "AK47 BULLET ETH";
