...
contract Omoikane is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    address deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "Omoikane";
    string private _symbol = "Omoikane";
    uint8 private _decimals = 9;    
    uint256 private initialsupply = 900_000_000_000;
    ...
    uint256 private numTokensSellToAddToLiquidity = _tTotal.mul(5).div(1000);
