...
The Book of Ra was fashioned so that only one with a "key" might open it: indeed, the Book had a small puzzle-box-like object that, 
when opened, acted as the key with which to open the Golden Book. 



https://t.me/Destinyportaleth
...
contract TheBookOfRa is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Book Of Ra", "Destiny") {
