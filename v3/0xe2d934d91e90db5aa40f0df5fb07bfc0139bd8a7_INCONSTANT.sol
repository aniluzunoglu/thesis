...
contract INCONSTANT is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Inconstant";
    string private constant _symbol = "INCONSTANT";
    ...
    constructor () {
        ...
        _isExcludedFromFee[0x769a47B73E73A839C6dF2B0BeA7A044DBb393121] = true;
        _initialTax=8;
        _finalTax=4;
