...
Electrocat "Vitalik's favorite cat watch" 

Vitalik Buterin creator of Ethereum Loves Electrocat!

//
Electrocat featured on TIME Magazine & Vitalik's wrist:

https://time.com/6158182/vitalik-buterin-ethereum-profile/

//
Electrocat Featured on TIME twitter & Vitalik's Twitter:
...
contract ELECTROCAT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Electrocat";//
    string private constant _symbol = "ELECTROCAT";//
    ...
    address payable private _devAddress = payable(0xeCc5Ff58821Af9Fe1ee809489365BdAC1dDaA866);//
    address payable private _marketingAddress = payable(0xeCc5Ff58821Af9Fe1ee809489365BdAC1dDaA866);//
