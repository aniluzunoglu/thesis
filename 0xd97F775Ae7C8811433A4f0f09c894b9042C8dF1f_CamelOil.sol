...
1 day jeet lock before launch
1 month extend at 50k
1 year extend at 150k
...
contract CamelOil is Context, IERC20, Ownable {
    ...
    string private constant _name = "Camel Oil";
    string private constant _symbol = "COIL";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xf9352b42FA2Ba99c6f9eB9Fa1194B3145f078581);
