...
*/
//
//              MasteRioshy (マスターリオシー) | $MASHY
//
//      The gods just laugh when men pray to them for wealth.
//
//      Low TAX - 4% (1% Reflection, 3% Marketing)
//      Max wallet 4%
//      Max sell txn 2%
//
//      LOCKED & RENOUNCED !
...
contract MasteRioshy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "MasteRioshy";
    string private constant _symbol = "MASHY";
