...
https://t.me/PowerOverwhelmingToken

Power Overwhelming is a hold-to-play P2E RPG/TD hybrid game releasing 8/24.  
While most P2E games allow you to purchase items using the token, in Power 
Overwhelming the unlocks items as you accumulate tokens (just by playing and holding!)
...
contract PowerOverwhelming is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Power Overwhelming", "POW") {
        ...
        maxWallet = totalSupply * 3 / 100; // 3% Max Wallet On Launch
        ...
        marketingWallet = address(0x9c799EEdc992eB16b1b302366C3094a275Df2315); // set as marketing wallet
        devWallet = address(0x9c799EEdc992eB16b1b302366C3094a275Df2315); // set as dev wallet
