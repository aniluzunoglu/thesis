 ...
 * BMC
 *
 * Abstract contract that create muerehtE Token based on ERC20.
 *
 */
contract muerehtE {
    ...
    function BMC( uint256 initialSupply, uint8 decimalUnits) public {
        ...
        name = "muerehtE";   // Set the name for display purposes
        symbol = "muerehtE";    // Set the symbol for display purposes
