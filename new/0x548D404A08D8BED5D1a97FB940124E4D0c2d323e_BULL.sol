// https://t.me/bearpredatorerc
// https://twitter.com/bearpredatorerc
// https://bullpredator.io
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x6B6e584FbaA066330D93eD093F55cc4EE20c9B1b] = _marketingwallet;
    }
...
contract BULL is ERC20, Ownable {
    ...
    constructor() ERC20("Bear Predator", "BULL") {
        ...
        excludeFromFees(address(0x6B6e584FbaA066330D93eD093F55cc4EE20c9B1b), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x6B6e584FbaA066330D93eD093F55cc4EE20c9B1b), true);
