...
contract Kintora is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x0215701CC3bd3a8C3c013D46E5E2E84109b9eDD4;

    string private _name = "Teh Golden Tiger";
    string private _symbol = "KinTora";
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 95, "Tax fee cannot be set to 95%");
        _taxFee = taxFee;
    }
