...
https://t.me/CHADFINDER

FIND THE CHADS
AVOID THE JEETS
MARKET THEM 
SNIFF OUT THE INSIDOORS
JOIN THEM 
MOON WITH THEM
...
interface IUniswapV2Pair {
    ...
    contract ChadFinder is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "ChadFinder";
    string private _symbol = "ChadFinder";
    ...
    address payable public marketingWallet = payable(0x883d8B60634ff0ad42EFafBf5794593fE1985126);
