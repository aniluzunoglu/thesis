/**
    ...
    conversate and song to the desires of the
    market, OLD FLOKI will entertain and bring us to the  moon.

    TG: https://t.me/OldFlokiErc20
    TWITTER: https://twitter.com/Oldflokierc
    WEBSITE: https://www.oldfloki.com/
*/
...
contract OldFloki is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5f0eA7bdC70DdF498bA6Cf77ab27E4e4323289ab); 
    address payable public Wallet_Team = payable(0x298EEb71F5c522d7838716d813d1767fc9485460);
    ...
    string private constant _symbol = unicode"OLD FLOKI"; 
    ...
    constructor () {
        ...
        _owner = 0x298EEb71F5c522d7838716d813d1767fc9485460;
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x5f0eA7bdC70DdF498bA6Cf77ab27E4e4323289ab); // Testnet
