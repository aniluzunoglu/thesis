...
First Ragdoll token on ERC 20!!!

Ragdoll is a committed to developing ERC-based DeFi protocols and aims to provide all-in-one financial solutions to its users. The Ragdoll cat can be described in three words big, beautiful, and friendly. 
With silky, medium-length fur that's similar to a Persian or Angora and the sizable body—and affable personality—of a small puppy, the Ragdoll is a favorite breed among cat fanciers.

🐱LINK: https://t.me/RagdollETH
🐱TWITTER: https://twitter.com/EthRagdoll
🐱INSTAGRAM:https://www.instagram.com/ragdolleth/
🐱WEBSITE: https://ragdollerc.com
...
contract Ragdoll is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x694564d75F286AA6CEc946f6eF4D12B72CC1b12e); 
    address payable public Wallet_Team = payable(0x694564d75F286AA6CEc946f6eF4D12B72CC1b12e);
    ...
    constructor () {
        ...
        _owner = 0x694564d75F286AA6CEc946f6eF4D12B72CC1b12e;
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x694564d75F286AA6CEc946f6eF4D12B72CC1b12e); // Testnet
