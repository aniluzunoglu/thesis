...
/*
The Lost Empire is glowing blue, and we are on our way to find the lost empire.
It's not just Atlantis, it's us. Mind, body, the collision of extremes.
Tsunami, whirlpool, undercurrent, reef, right in front of me.
https://twitter.com/lostempireth
*/
...
contract ATLANTIS is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Lost Empire';
    ...
    //DevWallets
    address public Development=payable(0x2d53b10dE94512Db4C6073E1a133abd127fA9FC2);
    address public Marketing=payable(0x81fB9DB97e59Bb254Ba7b338F1C2d7d4c1F36652);
    //MainNet
