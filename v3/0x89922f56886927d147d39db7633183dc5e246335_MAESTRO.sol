...
With Maestro's audio NFT's things work a little differently. 
You aren't being paid per-stream, you're being paid per edition. 
Think of it kind of like the digital version of a rare limited edition vinyl record release. 
You mint your 'audio' token to the blockchain complete with album art and a high quality mp3. 
You determine how many editions you would like to make permanently available... 
Then you release it on a marketplace.. 

Website:   https://www.ethmaestro.org/
...
contract MAESTRO is ERC20, Ownable {
    ...
    constructor() ERC20("MAESTRO", "MAESTRO") {
    ...
    ; uint256 totalSupply = 1.234 * 1e12 * 1e18;
