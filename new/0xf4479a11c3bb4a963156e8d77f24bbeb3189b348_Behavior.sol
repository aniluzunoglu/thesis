...
How will you behave in this market? //

Will you hold? //
Will you sell? //

Will you rally the community? //
Will you spread the word and shill your bag? //
Will you come together to create a community telegram? //
Will you work together and decide how this token behaves? //

No socials //
No team tokens //

How this token performs depends on both you and the community's behavior //

Liquidity lock will be extended based on how this token behaves //
...
contract Behavior is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Behavior", "BHVR") {
