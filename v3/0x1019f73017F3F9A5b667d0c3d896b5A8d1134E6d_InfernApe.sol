...
contract InfernApe is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 10 * 1e3 * 1e6; //2%
    uint256 public j_maxtxn = 5 * 1e3 * 1e6; //.5%
    ...
    address payable private infernoWallet = payable(0x46A78a2B7F55B67fb4B2faE5df315E71c5b7DD7b);
    address payable private jeetWallet = payable(0xE54F58F9c81246F81AeD4ED541DB89f58F98cA74);
