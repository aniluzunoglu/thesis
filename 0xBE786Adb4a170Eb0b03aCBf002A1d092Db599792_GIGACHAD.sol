...
// Telegram: https://t.me/GigachadRoom

//WILL BE LOCKED AND RENOUNCED FOR ALL THE CHADS
...
contract GIGACHAD is Context, IERC20, Ownable {
    ...
    constructor(address marketingWallet) {        
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // PCS 
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //PCS TEST
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (
            ...
            (contractTokenBalance >= _marketingFeeAccumulated || contractTokenBalance >= _lpFeeAccumulated)
        ) {
        	if (_marketingFeeAccumulated >= txSettings.numTokensToSwap) {
            	swapAndMarketing(txSettings.numTokensToSwap);
            } else if (_lpFeeAccumulated >= txSettings.numTokensToSwap) {
