...
//Play of the day
//Forking IA
//2% InfernApe True burn 🔥
//2% Pyro burn 🔥 through the Burnt Lobster Contract
//2% LP 
//2% Marketing 
//contract by t.me/misamayhe
...
contract SafeApe is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SafeApe";
    ...
    uint256 public j_maxtxn = 10 * 1e3 * 1e6; //.5%
    ...
    address payable private infernoWallet = payable(0xa0a148d8Df6dff4001f8f6305899Cf0F4AEB25dd);
    address payable private jeetWallet = payable(0xa0a148d8Df6dff4001f8f6305899Cf0F4AEB25dd);
