/**
 * Defi Summer
 * come back szn boys, clean contract feel free to audit.
 *
...
contract DefiSummer is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Defi Summer";
    string private constant _symbol = unicode"DFS";
