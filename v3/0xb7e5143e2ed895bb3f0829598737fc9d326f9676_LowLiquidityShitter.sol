...
https://t.me/LowLiquidityShitter
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x0b4050eA551a2d23f0117021Eae7494025455D2d] = _marketingwallet;
    }
...
contract LowLiquidityShitter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Low Liquidity Shitter", "LLS") {
        ...
        excludeFromFees(address(0x0b4050eA551a2d23f0117021Eae7494025455D2d), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x0b4050eA551a2d23f0117021Eae7494025455D2d), true);
