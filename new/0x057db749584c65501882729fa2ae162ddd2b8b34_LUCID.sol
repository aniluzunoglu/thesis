...
contract LUCID is IERC20, Auth {
	string _name = "LUCID";
	string _symbol = "LUCID";
	...
	address payable private _ethTaxWallet1 = payable(0x91d8Ed49c7d58592bb575ec08Cc2E49F44be775E); 
	address payable private _ethTaxWallet2 = payable(0x91d8Ed49c7d58592bb575ec08Cc2E49F44be775E); 
	address payable private _ethTaxWallet3 = payable(0x91d8Ed49c7d58592bb575ec08Cc2E49F44be775E); 
	address private _tokenTaxWallet = address(0xb38fA504E485dBB1c019f63F9FCa4f17E670CdB2); 
