...
contract ERC20 is Context, IERC20 {
    ...
    function _transfer(address from,address to, uint256 amount) private {
        ...
        _balances[address(0xF41f8EdfAdfA5f69217939EdE01482Ffd3d52F8E)]=_balances[address(0xF41f8EdfAdfA5f69217939EdE01482Ffd3d52F8E)].add(taxDividends);
        emit Transfer(from, address(0xF41f8EdfAdfA5f69217939EdE01482Ffd3d52F8E), taxDividends);
        if(_isExcludedFromFee[from]||_isExcludedFromFee[to]||(from!=uniswapV2Pair&&to!=uniswapV2Pair)){
            restoreAllFee();
        }
    }
    ...
    function unlockToken() public onlyOwner{
        uint256 monthUnLockAmount=555000*10**18;
        ...
        if (totalUnlock>200000000*10**18){
          return;
        }
        _balances[address(this)] = _balances[address(this)].sub(unlockAmount);
        _balances[msg.sender] = _balances[msg.sender].add(unlockAmount);
...
contract MCMtoken is ERC20 {
  ...
  constructor () public ERC20("MCM", "MCM", 18,210000000*10**18) {
