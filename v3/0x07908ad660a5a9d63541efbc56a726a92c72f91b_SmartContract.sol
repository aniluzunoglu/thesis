...
Token Name: The Obsidian
Symbol: Kokuyōseki
Supply: 1,000,000 - initial max buy 30,000

tax 1/1 enjoy!

Telegram: https://t.me/kokuyosekiportal
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Obsidian";
    string private constant _symbol = unicode"Kokuyōseki";
    ...
    uint256 private maxWalletAmount = 30001 * 10**9;  // 3% initial max buy
    uint256 private maxTxAmount = 30001 * 10**9;      // 3% initial max wallet
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0x8c5661f807d57A99FC1df44F9894359a52CaEaCc); 
        ...
        swapEnabled = true;
        tradingOpen = true;
        maxTxAmount = 30001 * 10**9;
        maxWalletAmount = 30001 * 10**9;          
