...
Max wallet 3.0%
For token stability, in the first 12 hours, the "sell" tax will be doubled. It will be automatically dropped to 6% after.



DEV will communicate via "Telegram" and "Website"
Token - Renounced
Liquidity- Will Be Locked and Burnt consecutively

Introduction: Deep-sky objects are celestial objects that exist outside our solar system.
Three major types of deep-sky objects are nebulae, star clusters, and galaxies.
The word nebula is Latin and means "cloud." A nebula (plural = nebulae), therefore, is a cloud of gas and dust in space.
Three types of nebulae exist: bright, dark, and planetary.

There are 110 Messier objects, each designated by the letter M followed by a number.
Ironically, though this catalog has been Messier’s greatest claim to fame for more than 200 years,
these deep sky objects were not what he set out to observe. In fact, Messier considered them a nuisance
because he often initially mistook them for his real object of interest: comets.

Though the Messier catalog is not as comprehensive or scientifically organized as the more recent New General Catalogue,
which includes nearly 8,000 deep sky objects.

Today, Messier’s catalog is often used by amateur astronomers to complete an activity called a Messier marathon,
during which a club or solo astronomer tries to view as many Messier objects as possible in a single night.
...
contract A380 is Context, IERC20, Ownable {
    ...
    string private _name = "DEEP SKY PROTOCOL";
    string private _symbol = "A380";
    uint8 private _decimals = 18;

    uint256 private launchTime;
    bool public isOpen = false;
    
    address payable public marketingWallet = payable(0xA05f2A6fA58C1c6D334d658D1a1d510Bc3491a93);
    ...
    uint256 public minimumTokensBeforeSwap = 60 * 10**18;
    uint256 public _maxTxAmount = 110000 * 10**18;
    uint256 public maxWalletToken = 3300 * (10**18);
