...
contract VampireKnight is Context, IERC20, Ownable {
    ...
    string private constant _name = "Vampire Knight";
    string private constant _symbol = unicode" ヴァンパイア騎士";
    ...
    constructor () {
        _feeAddrWallet = payable(0xAE1B31E84Aa5f7DeC9116CDB885d3fa1cF4188e2);
