...
The time of everything in this world is here
Time itself is endless, but for everything else, it is limited
One moment leads to another
With a childlike sense of wonder you view the world
Forming precious memories

Time is fleeting
Eventually, memories fade to regret
Destined to be cast into oblivion
All we can do is embrace it, for there is no turning back

Your time is now

Twitter: https://twitter.com/TheVBeginning
Website: https://theverybeginning.com/
...
contract TheVBeginning is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Very Beginning", "$TVB") {
