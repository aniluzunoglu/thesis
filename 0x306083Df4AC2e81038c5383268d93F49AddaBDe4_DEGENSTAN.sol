...
contract DEGENSTAN is Context, IERC20, Ownable {
    ...
    string private _name = "DEGENSTAN";
    string private _symbol = "DEGEN$TAN";
    ...
    address payable public marketingaddress = payable(0xa1CAD8CB198532F14C3EF4FF71381BF02531C17d);
