...
From "guardian" in the Muromachi period through the Sengoku period to the major lists of the Edo period, 
the title has a long and varied history.
...
contract Daimyo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Daimyo";
