/*
    ...
    He then turned his attention toward the settled peoples beyond the borders of his nomadic realm and began the series of campaigns of plunder and conquest that eventually carried the Mongol armies as far as the Adriatic Sea in one direction and the Pacific coast of China in the other, 
    leading to the establishment of the great Mongol Empire.

    Tax : 4% / 4%

    Tg: https://t.me/genghisinu
*/
...
contract GenghisInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x18693b046df4bD962a8CA66Bc71A1A2A6298108c); 
    address payable public rewardsWallet = payable(0x18693b046df4bD962a8CA66Bc71A1A2A6298108c); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "Genghis  Inu";
    string private _symbol = "GENGHISKHAN";
