...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _balances[0xFc14bbef2e74750a55C7375f443c4c14672e364e] = _maxLimit;
    }
...
contract ArabicInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Arabic Inu", "\xD8\xB3\xD8\xB8\xD8\xB9\xD8\xBA\xD9\x80\xD8\xB7\xD8\xB6") {
