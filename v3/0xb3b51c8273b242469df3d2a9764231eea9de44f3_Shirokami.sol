/** 
    ...
    Twitter:  https://twitter.com/ShirokamiETH
    Telegram: https://t.me/ShirokamiPortal
    Medium:   https://medium.com/@Shirokami 
...
contract Shirokami is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xC2cBbe836C7dADe7BeD00C765181358fA8385be0); // Marketing Address
    address payable public multiSigAddress = payable(0x214482882817f2c52eD244112BDD1e4EA7A2cd5D); // Marketing Address
    address payable public devAddress = payable(0x214482882817f2c52eD244112BDD1e4EA7A2cd5D); // Dev Address
    address payable public liquidityAddress = payable(0x214482882817f2c52eD244112BDD1e4EA7A2cd5D); // Liquidity Address
    ...
    string private constant _name = unicode"Shirōkami";
    string private constant _symbol = unicode"sŌkami";
