...
contract FinalContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Climax";
    string private constant _symbol = "GSPOT";
    ...
    uint256 private _tTotal = 1050000 * 10**9;
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0x490CB233eAcDA9d6E2D4b14D022469e7e916ef92); 
