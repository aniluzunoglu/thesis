...
contract ETHERPUNKS is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xc7e22D719cA30C06c8cb0eB29077930EC3F6d19f));

    string private _name = "ETHERPUNKS";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(500); //50%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(3); //0.3%
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(500); // 50%
