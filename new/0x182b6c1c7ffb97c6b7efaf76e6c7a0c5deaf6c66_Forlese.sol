...
contract Forlese is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Forlese", "Abandon") {
     ...
     uint256 totalSupply = 1 * 10 ** 11 * 10 ** decimals();
        ...
        maxTransactionAmount = 5 * 10 ** 8 * 10 ** decimals(); // 0.5% maxTransactionAmountTxn
        maxWallet = 10 * 10 ** 8 * 10 ** decimals(); // 1% maxWallet
