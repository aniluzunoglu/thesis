...
contract YoseiErc is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 40_000_000 * 10**8;
    ...
    string private constant _name = unicode"Yō Sei";
    string private constant _symbol = unicode"YŌSEI";
    ...
    uint256 public _maxTxAmount = 800_000 * 10**8;
    uint256 public _maxWalletSize = 800_000 * 10**8;
