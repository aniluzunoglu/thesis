...
𝐇𝐚𝐧𝐝𝐬 𝐨𝐟 𝐌𝐢𝐝𝐚𝐬 ($𝐌𝐈𝐃𝐀𝐒)

The power to make money from whatever one undertakes is akin to Midas. 
As this token emerges out of the unknown, Midas is ready to take on the 
conquest towards financial freedom and stability. The decentralization
and anonymity of Midas' system keep everyone safe from usual decentralized
finance shenanigans.

Twitter: https://twitter.com/midaserc
Telegram: https://t.me/MidasErc
Website: Www.midaserc.com
*/
...
pragma solidity >=0.4.22 <0.9.0;
    ...
    contract HandsofMidas is Context, IERC20, Ownable {
        ...
        string private _name = 'Hands of Midas';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x116aB200AD60DE66d476562700D054B46387F1a0, 'We can not exclude Uniswap router.');
