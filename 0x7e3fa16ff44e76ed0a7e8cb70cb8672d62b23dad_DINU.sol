...
contract DINU is ERC20, Ownable {
    ...
    constructor() ERC20("Dragon Inu", unicode"🐲") {
		...
		marketingWallet = address(0xC2076Ada5A2D48127273710ecAc44b2647a8E9Ae); // set as marketing wallet
         
        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(0xC2076Ada5A2D48127273710ecAc44b2647a8E9Ae)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
      
        _isExcludedMaxBuyTransactionAmount[address(0xC2076Ada5A2D48127273710ecAc44b2647a8E9Ae)] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(0xC2076Ada5A2D48127273710ecAc44b2647a8E9Ae)] = true;
